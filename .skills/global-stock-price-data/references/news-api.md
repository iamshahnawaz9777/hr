...
**Endpoint:** `GET https://app-bwr96gbc6w3l-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-bwr96gbc6w3l-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
