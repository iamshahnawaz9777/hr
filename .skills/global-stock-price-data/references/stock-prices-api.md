...
**Endpoint:** `GET https://app-bwr96gbc6w3l-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote`
...
async function getStockPrices(
  ...
  const response = await fetch(
    `https://app-bwr96gbc6w3l-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote?${query.toString()}`,
