...
**Endpoint:** `GET https://app-bwr96gbc6w3l-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday`
...
async function getIntradayData(symbol: string, params: IntradayParams = {}): Promise<IntradayResponse> {
  ...
  const response = await fetch(
    `https://app-bwr96gbc6w3l-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday?${query.toString()}`,
