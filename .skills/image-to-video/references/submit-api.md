...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-bwr96gbc6w3l-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
...
async function submitImageToVideo(params: {
  ...
  const response = await fetch(
    "https://app-bwr96gbc6w3l-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
